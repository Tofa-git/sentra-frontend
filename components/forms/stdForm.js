    ...
    return (
            <div className="d-flex flex-column h-100 stdForm" style={styles.stdForm}>
                <div className="stdFormHeader d-flex flex-shrink-1 align-items-center bg-secondary text-light p-1 px-2">
                    <i className="material-icons fs-6" style={{verticalAlign: 'middle'}}>{icon}</i>
                ...
                <div className="stdFormHeader flex-shrink-1 bg-light text-primary small p-1 px-2" style={styles.stdFormHeader}>{footer}</div>
            </div>
    )
