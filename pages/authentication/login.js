                ...
                <div className="col-sm-4 p-4 mh-100 bg-white shadow text-center" style={{borderRadius: '10px', minWidth: '350px', backgroundColor: 'rgba(255,255,255,0.75)', boxShadow: '0px 0px 10px #aaaaaa'}}>
                    ...
                    <form onSubmit={loginHandler}>
                        <div className="d-flex mt-5">
                            ...
                            <input type="text" className="rounded-0 ps-5 form-control " value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Username or Email"/>
                        ...
                        <div className="d-flex mt-3">
                            ...
                            <input type="password" className="rounded-0 ps-5 form-control" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password"/>
                            <div className="p-2 bg-secondary d-flex clearValue" style={{cursor: 'pointer'}} title="Clear username">
                                <i className="material-icons align-self-center text-info fs-5">visibility_off</i>
                            </div>
                        </div>
